...
import { SlateToolbar, SlateContent } from 'slate-editor';
...
class RichTextExample extends React.Component {
    ...
    return (
      <div>
        ...
        >
          <SlateToolbar>
            <ImageButton
              signingUrl={process.env.REACT_APP_API_URL + process.env.REACT_APP_SIGNING_URL_ENDPOINT}
  ...
  renderNode = (props, editor, next) => {
    ...
    switch (node.type) {
      ...
      //  return <FluidContainer {...attributes}> {children}</FluidContainer>;
      default:
        return next();
    }
  };
